        ...
        {tab === "membership" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              ...
              <div style={{ background: customer.free_coffee ? "#F0FDF4" : "#F5F5F5", border: `1px solid ${customer.free_coffee ? "#86EFAC" : "#E5E5E5"}`, borderRadius: 12, padding: 16, textAlign: "center" }}>
                <div style={{ fontSize: 28 }}>{customer.free_coffee ? "☕" : "—"}</div>
                <div style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: customer.free_coffee ? "#166534" : "#888", marginTop: 4 }}>
