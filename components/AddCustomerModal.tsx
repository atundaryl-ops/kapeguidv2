    ...
    return (
      <div className="modal-backdrop" onClick={(e) => e.target === e.currentTarget && onClose()}>
        <div className="w-full max-w-md rounded-sm animate-slide-up overflow-hidden"
          ...
          <div className="p-5">
            <p className="text-xs mb-4 text-center" style={{ color: "var(--text-muted)" }}>QR code is ready — print or save it now.</p>
            <div className="flex justify-center mb-4">
              <div className="rounded-sm overflow-hidden" style={{ background: "#FFFFFF", padding: 16, border: "1px solid var(--border2)" }}>
                {qrDataUrl
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 p-3 rounded-sm"
                ...
                <label htmlFor="free_coffee" className="text-xs cursor-pointer" style={{ color: "var(--text)" }}>
